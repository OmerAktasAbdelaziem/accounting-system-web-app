    ...
    <div class="row w-100">
        <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
            <div class="card border-0 shadow-lg p-5">
                ...
                <h2 class="mt-3 mb-2">{{ __('errors.access_forbidden') }}</h2>
                
                <p class="text-muted mb-4">
                    {{ __('errors.you_do_not_have_permission_to_access_this_resource') }}
                </p>
                ...
                <p class="text-muted small">
                    ...
                    {{ __('errors.error_code') }}: 403 | {{ __('errors.contact_support_if_you_believe_this_is_an_error') }}
                </p>
            </div>
        </div>
    </div>
