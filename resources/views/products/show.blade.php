    ...
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <h3>${{ number_format($product->selling_price, 2) }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-success fw-bold">${{ number_format($product->selling_price, 2) }}</p>
                    </div>
                </div>
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr class="table-info">
                        ...
                        <td><strong>${{ number_format($product->current_stock * $product->selling_price, 2) }}</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="table-warning">
                        ...
                        <td><strong>${{ number_format($product->current_stock * $product->purchase_price, 2) }}</strong></td>
                    </tr>
                    <tr class="table-success">
                        <td><strong>{{ __('messages.total_profit_potential') }}</strong></td>
                        <td><strong style="color: #27ae60;">${{ number_format($product->current_stock * ($product->selling_price - $product->purchase_price), 2) }}</strong></td>
                    </tr>
                </table>
            </div>
        </div>
