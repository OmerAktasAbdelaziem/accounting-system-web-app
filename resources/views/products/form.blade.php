        ...
        <div class="form-grid">
            ...
            <div class="form-sidebar">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-stat">
                        <span class="sidebar-stat-label">Created</span>
                        <span class="sidebar-stat-value">{{ $product->created_at?->format('M d, Y') ?? 'N/A' }}</span>
                    </div>
                    <div class="sidebar-stat">
                        <span class="sidebar-stat-label">Last Updated</span>
                        <span class="sidebar-stat-value">{{ $product->updated_at?->format('M d, Y') ?? 'N/A' }}</span>
                    </div>
                </div>
                @endif
            </div>
            ...
            <div class="form-card">
                <div class="form-header">
                    <div>
                        <h1><i class="bi bi-box-seam" style="margin-right: 10px;"></i>{{ isset($product) ? __('messages.edit_product') : __('messages.add_product') }}</h1>
                    </div>
                ...
                <form method="POST" action="{{ isset($product) ? route('products.update', $product->id) : route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('purchase_price') is-invalid @enderror" name="purchase_price" step="0.01" value="{{ old('purchase_price', $product->purchase_price ?? '') }}" required>
                                    @error('purchase_price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="form-group">
                                    <label class="form-label">{{ __('messages.price') }} *</label>
                                    <input type="number" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price" step="0.01" value="{{ old('selling_price', $product->selling_price ?? '') }}" required>
                                    @error('selling_price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('current_stock') is-invalid @enderror" name="current_stock" value="{{ old('current_stock', $product->current_stock ?? 0) }}" required>
                                    @error('current_stock')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> {{ isset($product) ? __('messages.update') : __('messages.save') }}
                        </button>
                        <a href="{{ route('products.index') }}" class="btn btn-secondary">
                            {{ __('messages.cancel') }}
                        </a>
