            ...
            <div class="card">
                ...
                <form action="{{ route('super-admin.merchants.update', $merchant) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_currencies" class="form-control @error('max_currencies') is-invalid @enderror"
                                       value="{{ old('max_currencies', $merchant->max_currencies) }}" min="1" max="20" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_languages" class="form-control @error('max_languages') is-invalid @enderror"
                                       value="{{ old('max_languages', $merchant->max_languages) }}" min="1" max="10" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="default_language" class="form-select @error('default_language') is-invalid @enderror" required>
                                    <option value="en" {{ old('default_language', $merchant->default_language) == 'en' ? 'selected' : '' }}>English</option>
                                    <option value="ar" {{ old('default_language', $merchant->default_language) == 'ar' ? 'selected' : '' }}>Arabic</option>
                                    <option value="tr" {{ old('default_language', $merchant->default_language) == 'tr' ? 'selected' : '' }}>Turkish</option>
                                </select>
                    ...
                    <div class="card-footer bg-light">
                        ...
                        <a href="{{ route('super-admin.merchants.show', $merchant) }}" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
