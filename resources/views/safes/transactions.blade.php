...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="stat-card green">
            ...
            <div class="value" style="color: var(--primary-green);">${{ number_format($safe->balance, 2) }}</div>
            ...
            <form method="POST" action="{{ route('safes.withdraw', $safe->id) }}">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <strong>{{ __('messages.available_balance') }}:</strong> ${{ number_format($safe->balance, 2) }}
                    </div>
                    <div class="form-group mb-3">
