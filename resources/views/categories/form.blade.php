        ...
        <div class="form-grid">
            ...
            <div class="form-sidebar">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-stat">
                        <span class="sidebar-stat-label">Created</span>
                        <span class="sidebar-stat-value">{{ $category->created_at?->format('M d, Y') ?? 'N/A' }}</span>
                    </div>
                    <div class="sidebar-stat">
                        <span class="sidebar-stat-label">Status</span>
                        <span class="sidebar-stat-value" style="color: {{ $category->is_active ? '#10b981' : '#ef4444' }};">{{ $category->is_active ? 'Active' : 'Inactive' }}</span>
                    </div>
                </div>
                @endif
            </div>
            ...
            <div class="form-card">
                <div class="form-header">
                    <div>
                        <h1><i class="bi bi-tags" style="margin-right: 10px;"></i>{{ isset($category) ? __('messages.edit_category') : __('messages.add_category') }}</h1>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row" style="margin-bottom: 0;">
                                <div class="form-group">
                                    <label class="form-label">{{ __('messages.description') }}</label>
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Enter category description" rows="4">{{ old('description', isset($category) && $category ? $category->description : '') }}</textarea>
