    ...
    <div class="row w-100">
        <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center">
            <div class="card border-0 shadow-lg p-5">
                ...
                <h2 class="mt-3 mb-2">{{ __('errors.service_unavailable') }}</h2>
                
                <p class="text-muted mb-4">
                    {{ __('errors.the_server_is_currently_under_maintenance_or_experiencing_issues') }}
                </p>
                ...
                <p class="text-muted small">
                    ...
                    {{ __('errors.error_code') }}: 503 | {{ __('errors.please_try_again_later') }}
                </p>
            </div>
        </div>
    </div>
