            ...
            <div class="commission-form-body">
                @if(!$commission && isset($employees) && $employees->isEmpty())
                    <div class="alert alert-warning mb-4">
                        {{ __('No eligible employees are available for first-time commission creation. Open an existing employee commission profile to add more commissions.') }}
                    </div>
                @else
                    @if(!$commission)
                        <div class="alert alert-info mb-4">
                            {{ __('This form creates the first commission profile for an employee. After that, add new commissions from the employee profile page.') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ isset($commission) ? route('commissions.update', $commission->id) : route('commissions.store') }}">
                        ...
                        <div class="commission-form-section">
                            <div class="commission-form-section-title">{{ __('Commission Details') }}</div>
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div class="commission-form-section">
                            <div class="commission-form-section-title">{{ __('Financial Details') }}</div>
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div class="commission-form-section">
                            <div class="commission-form-section-title">{{ __('Additional Information') }}</div>
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div class="commission-form-section">
                            <div class="commission-form-section-title">{{ __('Branches') }}</div>
